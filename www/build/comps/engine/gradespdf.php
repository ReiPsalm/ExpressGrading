...
while($rows = $getStud->fetchArray(SQLITE3_ASSOC)){
    ...
    //Total Q,A,O
    $PrgetAtt = $GradeCalc->GetQAO('attendance','att',$rows["stud_id"],'Prelim','Midterm',$_GET['dataID']);
    while($rowAtt = $PrgetAtt->fetchArray(SQLITE3_ASSOC)){
        $PrgetQz = $GradeCalc->GetQAO('quizes','quiz',$rows["stud_id"],'Prelim','Midterm',$_GET['dataID']);
        while($rowQz = $PrgetQz->fetchArray(SQLITE3_ASSOC)){
            $PrgetOr = $GradeCalc->GetQAO('orals','oral',$rows["stud_id"],'Prelim','Midterm',$_GET['dataID']);
            ...
            //Midterm Exam
            $getMdEx = $GradeCalc->GetExam($rows["stud_id"],'Midterm',$_GET['dataID']);
    ...
    //Total Q,A,O
    $SfgetAtt = $GradeCalc->GetQAO('attendance','att',$rows["stud_id"],'Semi','Final',$_GET['dataID']);
    while($rowAtt = $SfgetAtt->fetchArray(SQLITE3_ASSOC)){
        $SfgetQz = $GradeCalc->GetQAO('quizes','quiz',$rows["stud_id"],'Semi','Final',$_GET['dataID']);
        while($rowQz = $SfgetQz->fetchArray(SQLITE3_ASSOC)){
            $SfgetOr = $GradeCalc->GetQAO('orals','oral',$rows["stud_id"],'Semi','Final',$_GET['dataID']);
            ...
            //Prelim Exam
            $getPExam = $GradeCalc->GetExam($rows["stud_id"],'Semi',$_GET['dataID']);
            while($rowEx = $getPExam->fetchArray(SQLITE3_ASSOC)){
                //Prelim points
                $ix = 0;
                $PR = 0;
            ...
            //Midterm Exam
            $getMdEx = $GradeCalc->GetExam($rows["stud_id"],'Final',$_GET['dataID']);
            while($rowMdEx = $getMdEx->fetchArray(SQLITE3_ASSOC)){
                $mdix = 0;
                $MD = 0;
